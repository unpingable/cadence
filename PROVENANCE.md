...
### Architectural design and concept validation

Lead collaboration: ChatGPT (OpenAI). Initial concept validation of temporal
admissibility as a distinct application of the Δt framework, differentiated
from operational diagnostics (nq) and authorization governance (standing).
